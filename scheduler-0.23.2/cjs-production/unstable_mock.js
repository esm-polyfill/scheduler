...
var require_scheduler_unstable_mock_production_min = __commonJS({
  "node_modules/scheduler-0.23.2/cjs/scheduler-unstable_mock.production.min.js"(exports2) {
    "use strict";
    function f(a, b) {
      var c = a.length;
      a.push(b);
    ...
    exports2.unstable_advanceTime = function(a) {
      "disabledLog" === console.log.name || K || (x += a, null !== A && B <= x && (A(x), B = -1, A = null));
    };
    exports2.unstable_cancelCallback = function(a) {
      a.callback = null;
    };
    exports2.unstable_clearYields = function() {
      if (null === C) return [];
      var a = C;
      C = null;
      return a;
    ...
    exports2.unstable_flushAll = function() {
    ...
    exports2.unstable_flushAllWithoutAsserting = P;
    exports2.unstable_flushExpired = function() {
      if (H) throw Error("Already flushing work.");
      if (null !== y) {
        H = true;
        try {
    ...
    exports2.unstable_flushNumberOfYields = function(a) {
      if (H) throw Error("Already flushing work.");
      if (null !== y) {
        var b = y;
        F = a;
    ...
    exports2.unstable_flushUntilNextPaint = function() {
      if (H) throw Error("Already flushing work.");
      if (null !== y) {
        var a = y;
        J = true;
    ...
    exports2.unstable_setDisableYieldValue = function(a) {
      K = a;
    };
    exports2.unstable_shouldYield = O;
    ...
    exports2.unstable_yieldValue = function(a) {
